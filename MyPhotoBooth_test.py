...
screen = pygame.display.set_mode((1920,810),pygame.NOFRAME) #testing
...
def updateDisplay():
    ...
    background.blit(smallText,(10,775)) #Write the small text
    smallText = smallfont.render(`totalImageCount`+"/"+`photosPerCart`,1, (255,0,0))
    background.blit(smallText,(1830,775)) #Write the image counter
    ...
    pygame.draw.rect(screen,pygame.Color("red"),(10,10,1890,760),2) #Draw the red outer box
    pygame.display.flip()
...
def main(threadName, *args):
    ...
    camera.preview_window = (0,0,1920,810)
    ...
    while closeme:
        ...
        emptyImage = PIL.Image.new('RGB',(480,270))
        emptyImage.save('/home/pi/Desktop/tempdisplay1.jpg')
        emptyImage.save('/home/pi/Desktop/tempdisplay2.jpg')
        emptyImage.save('/home/pi/Desktop/tempdisplay3.jpg')
        emptyImage.save('/home/pi/Desktop/tempdisplay4.jpg')
